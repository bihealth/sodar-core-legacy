# -*- coding: utf-8 -*-
# Generated by Django 1.11.15 on 2018-09-20 16:25
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('level', models.CharField(choices=[('AVAIL', 'View project availability'), ('INFO', 'View project information'), ('ROLES', 'View and synchronize project information and user roles')], default='AVAIL', help_text='Project access level', max_length=255)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('url', models.URLField(help_text='Site URL', max_length=2000, unique=True)),
                ...
                ('secret', models.CharField(help_text='Secret token for connecting to the source site', max_length=255, unique=True)),
